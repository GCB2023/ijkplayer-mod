...
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libcodec2"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libdav1d"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libdavs2"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libuavs3d"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libmfx"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libkvazaar"
...
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libopencore-amrwb"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libvo-amrwbenc"
...
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libopenjpeg"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-librav1e"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libsvtav1"
...
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libxavs2"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libxeve"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libxevd"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libzvbi"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libsvtav1"
